...
class Reservation(models.Model):
    ...
    address = models.TextField()
     ...
     # Luggage fields
    LUGGAGE_CHOICES = (
        ('hand_carry', 'Hand Carry (7kg max)'),
        ('checked_bag', 'Checked Baggage (23kg max)'),
        ('extra_bag', 'Extra Baggage (32kg max)'),
    ...
    def luggage_info(self):
        return f"{self.get_luggage_type_display()} ({self.luggage_weight}kg)"
